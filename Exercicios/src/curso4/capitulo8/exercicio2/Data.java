...
public class Data
{
    ...
    public int getDiasCorridos()
    {
        ...
        // Verifica quantos anos são bissextos.
    ...
    public int diferencaData(int dia, int mes, int ano)
    {
        if (isValidDate(dia, mes, ano))
        {
            ...
            return dt.getDiasCorridos() - this.getDiasCorridos();
        }
        
        return 0;
    }
    
    public int diferencaData(String data)
    {
        String[] dt = data.split("/");
        if (dt.length == 3)
        {
    ...
    public int diferencaData(Data data)
    {
        ...
        {
            return diferencaData(data.getDia(), data.getMes(), data.getAno());
        }
    ...
    {
        Data dt = new Data(15, 10, 2016);
        Data other = new Data(31, 12, 2016);
        System.out.println(dt.diferencaData(other));
    }
}
